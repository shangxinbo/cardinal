...
exports.getParamLength = function(methodName) {
    return cryptoParamLength[methodName];
};

exports.generateKey = function(methodName, secret) {
    const secretBuf = new Buffer(secret, 'utf8');
    const tokens = [];
    const keyLength = module.exports.getParamLength(methodName)[0];
...
exports.createCipher = function(secret, methodName, initialData, _iv) {
    const key = module.exports.generateKey(methodName, secret);
    const iv = _iv || crypto.randomBytes(module.exports.getParamLength(methodName)[1]);
...
exports.createDecipher = function(secret, methodName, initialData) {
    const ivLength = module.exports.getParamLength(methodName)[1];
