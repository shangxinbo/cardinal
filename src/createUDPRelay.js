...
const ip = require('ip');
const getDstInfoFromUDPMsg = require('./utils').getDstInfoFromUDPMsg;
const sendDgram = require('./utils').sendDgram;
...
exports.createUDPRelay = function(config, isServer, logger) {
